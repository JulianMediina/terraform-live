...
module "site_bucket" {
  source = "git::https://github.com/JulianMediina/terraform-modules.git//modules/s3-site?ref=v0.1.3"
...
module "cdn" {
  source = "git::https://github.com/JulianMediina/terraform-modules.git//modules/cloudfront-oac?ref=v0.1.3"
...
module "observability" {
  source = "git::https://github.com/JulianMediina/terraform-modules.git//modules/observability?ref=v0.1.3"
